 ...
 * прерванные перезапуском или развёртыванием, и запустить планировщик отложенных
 * публикаций (lib/carousel/runnerControl.ts). Ошибка здесь не мешает запуску сайта.
 *
