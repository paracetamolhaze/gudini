...
- Максимум один emoji и только если он нужен. В конце один-два тега по теме, только латиницей и по-английски (#bitcoin, #crypto, #perps, #ethereum) — русские теги в X не ищут, а больше двух читается как спам.
