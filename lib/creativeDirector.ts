...
Внешние материалы не перекрывают экран. Каждый показывается прямоугольной
ИЛЛЮСТРАЦИЕЙ В ВЕРХНЕЙ ЧАСТИ КАДРА, поверх автора — как подпись к тому, о чём
он сейчас говорит. Размер и положение вставки задаёт программа, тебе о них
думать не нужно: ты решаешь только ЧТО показать и НА КАКИХ СЛОВАХ.
...
5. Первые ${T.first_visual_after} секунды — только лицо автора, туда вставок не ставь.
...
8. Формат материала подчиняется смыслу, а не квоте. Человек, портрет, предмет,
   статичный факт — обычно фото. Конкретное действие или сам момент события —
   видео. Если под фразу есть точное видео события, не подменяй его слабой
   картинкой; если фраза статична, хорошее фото лучше случайного видео.
