...
- Это готовый монолог ОТ ЛИЦА АВТОРА для его зрителей, не ответ ассистента заказчику.
  В теме выбора автор занимает позицию: «я выделяю», «мой выбор», «я бы выбрал» — и даёт основания.
...
- В хуке обозначь ответ на тему; основная часть раскрывает именно это обещание.
  ...
  Аргументы бери из исследования; не обещай гарантированной прибыли или результата.
  Существенное ограничение можно кратко встроить в объяснение, но оно не заменяет выбор.
  Если данных недостаточно, честно обозначь предел конкретного вывода; не выдумывай аргументы
  и не выдавай универсальный чек-лист за ответ на исходную тему.
