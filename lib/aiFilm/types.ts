...
export type ObjectState = {
  /** короткий устойчивый идентификатор предмета: main-canopy, reserve-canopy, parcel, phone */
  id: string;
...
export type StoryBeat = {
  ...
  anchorPhrase: string;
  /**
   * Секунда внутри показанного окна, на которой звучит якорь. Считается по пословной
   * расшифровке. null — якоря нет или он в речи не найден.
   */
